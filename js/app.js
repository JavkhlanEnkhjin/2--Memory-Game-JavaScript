  ...
  Conatiner.setAttribute('style','display:none;'); //hide game cards
       ...
       switch (starContainer.childElementCount) {
         ...
         timeHeader.insertAdjacentHTML('afterbegin',
          `<h3>Баяр хүргэе<br><i class="fa fa-star"></i></br></h3>`);
           break;
         case 2:
         timeHeader.insertAdjacentHTML('afterbegin',
          `<h3>Баяр хүргэе<br><i class="fa fa-star"></i>\t<i class="fa fa-star"></i></br></h3>`);
           break;
         case 3:
         timeHeader.insertAdjacentHTML('afterbegin',
          `<h3>Баяр хүргэе<br><i class="fa fa-star"></i>\t<i class="fa fa-star"></i>\t<i class="fa fa-star"></i></br></h3>`);
           break;
         case 0:
         timeHeader.insertAdjacentHTML('afterbegin',
          `<h3>Баяр хүргэе</h3>`);
